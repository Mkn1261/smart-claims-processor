...
A production-style multi-agent insurance claims automation platform built using LangGraph, CrewAI, FastAPI, React, and modern Large Language Models.
...
Smart Claims Processor automates insurance claim processing through a coordinated network of AI agents. The system validates incoming claims, performs fraud analysis, assesses damages, verifies policy compliance, calculates settlements, and supports human review for high-risk cases.

The project demonstrates real-world agentic AI patterns including multi-agent orchestration, human-in-the-loop workflows, checkpointed execution, memory-enhanced reasoning, evaluation pipelines, cost guardrails, and production-ready API integration.
...
* CrewAI-based fraud investigation crew
* Human-in-the-loop approvals with interrupt/resume execution
* Agent memory powered by ChromaDB and semantic retrieval
* LLM-as-Judge evaluation framework
* Pluggable LLM providers (Gemini and Groq)
* Country-aware claim processing (India and US)
* Role-based access control with JWT authentication
* Cost tracking, token monitoring, and operational guardrails
...
git clone https://github.com/Mkn1261/smart-claims-processor
...
```bash
cd smart-claims-processor/frontend
npm install
